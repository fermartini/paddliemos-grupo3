    ...
    <BookingProvider>
      ...
      <main className='min-h-screen bg-base-200 flex flex-col'>
        <header className='bg-base-100 shadow-md py-4'>
          <div className='container mx-auto px-4 flex justify-between items-center'>
            <div className='flex items-center gap-2'>
              <img src={'/kineclick.webp'} alt='logo' className='w-22 h-22' />
              <span>
                <h1 className='text-3xl font-bold text-primary'>KinesioClick Turnos</h1>
                <p className='text-secondary'>
                  Sistema de reservas online de turnos de kinesiología
                </p>
              </span>
            </div>
          </div>
        ...
        <section className='container mx-auto px-4 py-8 flex-grow'>
          <div className='text-center mb-8'>
            ...
            <p className='text-lg text-secondary'>
              Reserva fácilmente tu turno de kinesiología
            </p>
          </div>
        ...
        <footer className='bg-base-100 py-6'>
          <div className='container mx-auto px-4 text-center'>
            <p className='text-sm'>
              © 2025 KinesioClick Turnos - Todos los derechos reservados
            </p>
          </div>
        </footer>
      </main>
